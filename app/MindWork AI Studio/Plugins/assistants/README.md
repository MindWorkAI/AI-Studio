...
- Direct chat launchers instead require `LaunchBehavior = "OPEN_WORKSPACE_CHAT_BY_NAME"` and `WorkspaceName`. Form-only fields are optional for backward compatibility and are ignored when launch behavior is active.
