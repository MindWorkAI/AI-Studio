...
public static class ComponentsExtensions
{
    ...
    public static string Name(this Components component) => component switch
    {
        ...
        Components.SWOT_ANALYSIS_ASSISTANT => TB("SWOT Analysis Assistant"),
    ...
    public static ComponentsData GetData(this Components destination) => destination switch
    {
        ...
        Components.SWOT_ANALYSIS_ASSISTANT => new(Event.SEND_TO_SWOT_ANALYSIS_ASSISTANT, Routes.ASSISTANT_SWOT_ANALYSIS),
    ...
    public static ConfidenceLevel MinimumConfidence(this Components component, SettingsManager settingsManager) => component switch
    {
        ...
        Components.SWOT_ANALYSIS_ASSISTANT => settingsManager.ConfigurationData.SWOTAnalysis.PreselectOptions ? settingsManager.ConfigurationData.SWOTAnalysis.MinimumProviderConfidence : default,
    ...
    public static AIStudio.Settings.Provider PreselectedProvider(this Components component, SettingsManager settingsManager)
    {
        var preselectedProvider = component switch
        {
            ...
            Components.SWOT_ANALYSIS_ASSISTANT => settingsManager.ConfigurationData.SWOTAnalysis.PreselectOptions ? settingsManager.ConfigurationData.Providers.FirstOrDefault(x => x.Id == settingsManager.ConfigurationData.SWOTAnalysis.PreselectedProvider) : null,
